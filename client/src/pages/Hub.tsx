...
import { MessageSquare, HelpCircle, BookOpen, Image, CheckCircle, Sparkles, Stethoscope, Users, Landmark, Map, Snowflake } from "lucide-react";
...
export default function Hub() {
  const { language, isSnowing, setIsSnowing } = useAppContext();
