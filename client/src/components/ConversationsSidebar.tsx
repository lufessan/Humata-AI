...
export function ConversationsSidebar({ onSelectConversation, currentConversationId, onNewConversation, persona }: ConversationsSidebarProps) {
  ...
  const { data: conversations = [] } = useQuery({
    queryKey: ["/api/conversations", localStorage.getItem("guestId"), persona],
    queryFn: async () => {
      ...
      const response = await fetch("/api/conversations", {
        ...
        credentials: "include",
        body: JSON.stringify({ guestId, persona }),
      });
